package br.com.janadev.budget.unit.inbound.expense;
...
import br.com.janadev.budget.inbound.expense.ExpenseController;
...
class ExpenseControllerTest extends TestSecurityMockConfig {
    ...
    void shouldRespondWithStatus200WhenFindAllExpensesSuccessFully() throws Exception {
        ...
        when(findAllExpensesPort.findAll(any())).thenReturn(expensesExpected);
