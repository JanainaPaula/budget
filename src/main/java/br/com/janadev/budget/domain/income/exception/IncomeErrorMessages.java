...
public class IncomeErrorMessages {
    ...
    public static final String UPDATE_FAILED_INCOME_NOT_FOUND = "Could not update. Income not found.";
    public static final String DELETE_FAILED_INCOME_NOT_FOUND = "Could not delete. Income not found.";
