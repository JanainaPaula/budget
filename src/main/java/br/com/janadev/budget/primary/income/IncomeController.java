...
public class IncomeController {
    ...
    public ResponseEntity<IncomeResponseDTO> register(@RequestBody IncomeRequestDTO request){
        var income = Income.of(request.description(), request.amount(), request.date(), 2L); //TODO: Pegar o usuário logado
    ...
    public ResponseEntity<IncomeResponseDTO> update(@PathVariable Long id, @RequestBody IncomeRequestDTO request){
        var command = Income.of(request.description(), request.amount(), request.date(), 2L); //TODO: Pegar o usuário logado
